...
export const VisitFeeSettings: React.FC = () => {
  ...
  return (
    <section className="bg-white dark:bg-slate-900 rounded-xl p-4 border border-slate-200 dark:border-slate-700 shadow-xs space-y-4">
      <div className="flex items-start gap-2 pb-2 border-b border-slate-100 dark:border-slate-800">
        <span className="w-8 h-8 rounded-lg bg-teal-50 dark:bg-teal-950/40 border border-teal-200 dark:border-teal-800 text-teal-700 flex items-center justify-center">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end gap-2">
        <label className="flex-1 text-xs font-semibold text-slate-700 dark:text-slate-300">
          ...
          <input
            ...
            className="mt-1 w-full rounded-lg border border-teal-200 dark:border-teal-800 bg-white dark:bg-slate-900 px-3 py-2 text-sm font-mono font-bold text-teal-800"
          />
        </label>
        <button
          type="button"
        ...
        <label className="flex-1 text-xs font-semibold text-slate-700 dark:text-slate-300">
          ...
          <div className="relative mt-1">
            <input
              ...
              className="w-full rounded-lg border border-teal-200 dark:border-teal-800 bg-white dark:bg-slate-900 pl-3 pr-8 py-2 text-sm font-mono font-bold text-teal-800"
            />
