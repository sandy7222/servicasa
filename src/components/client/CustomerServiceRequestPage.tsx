...
/** Página dedicada de "Solicitar un servicio" para el cliente — antes vivía
 * apilada arriba de todo en /customer, ahora es una cápsula del header
 * (mismo patrón que las de /technician: Ganancias, Historial, etc.). Ver
 * pedido de Sandy del 13/9. */
export const CustomerServiceRequestPage: React.FC = () => {
      ...
      <header className="border-b border-slate-800 bg-[#0F172A] text-white">
        <div className="mx-auto max-w-5xl px-4 py-5 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold">Solicitar un servicio</h1>
              <p className="text-xs text-slate-400">Elegí el rubro, contanos qué necesitás y coordinamos un técnico.</p>
            </div>
          </div>
          <button
