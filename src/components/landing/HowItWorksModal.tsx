  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {LANDING_STEPS.map((s) => (
          <div key={s.step} className="flex flex-col items-center text-center gap-2 p-4 rounded-xl bg-slate-50 border border-slate-200">
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-3 text-xs sm:text-sm">
        <div className="flex-1 flex items-center gap-2 px-4 py-3 rounded-xl bg-teal-50 border border-teal-200 text-teal-800 font-semibold">
