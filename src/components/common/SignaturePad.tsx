      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 sm:p-5">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            className="text-xs font-medium text-slate-500 hover:text-rose-600 flex items-center gap-1 px-2.5 py-1 rounded bg-white border border-slate-200 shadow-2xs hover:bg-rose-50 transition-colors"
          >
        ...
        {/* Canvas area */}
        <div className="relative bg-white rounded-lg border-2 border-dashed border-slate-300 hover:border-teal-400 transition-colors h-44 sm:h-48 overflow-hidden touch-none cursor-crosshair">
          <canvas
            ref={canvasRef}
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full text-sm px-3 py-2 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent font-medium"
              required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-sm px-3 py-2 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
            />
          </div>
        </div>
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        {onCancel && (
          <button
            ...
            className="px-4 py-2 text-xs sm:text-sm font-semibold text-slate-600 hover:text-slate-800 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors"
          >
            Cancelar
          </button>
        )}
