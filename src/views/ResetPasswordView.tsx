...
export const ResetPasswordView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl border border-slate-200 shadow-xs p-6">
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <h1 className="text-base font-bold text-slate-900">Elegí tu nueva contraseña</h1>
        </div>
