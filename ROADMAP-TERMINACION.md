...
| 8. Calidad y CI | 🟡 Parcial sólido | 25/8/2026 | 1/9/2026 | commits `9cc8467`, `69ab7f8`, `535ffbd` | CI verde: lint, build, 106 Vitest, seguridad y reconstrucción de Supabase; 11 SQL rollback-safe live; faltan E2E autenticados, más componentes y rate limiting |
...
| 10. Lanzamiento | 🟡 En curso — no listo para lanzar | 27/8/2026 |  | `main` | `docs/fase10-checklist.md` (checklist inicial 27-28/8, pasada completa de release manager 2/9, cierre de restauración/contraseña 2/9); bloqueante de migraciones resuelto (40/40, 1 a 1); backup real re-tomado 2/9 (`pg_dump_2026_09_02.sql`, 51/51 tablas con datos); **restauración probada de punta a punta 2/9** (servidor Postgres local desechable, 51/51 tablas + filas reales); **contraseña de prueba rotada 2/9** (nueva contraseña real, verificada con login, actualizada en los 5 archivos vivos); login/auth confirmado de punta a punta contra `tecniurbano.online` real vía magic link admin; quedan 8/10 flujos del smoke test (en curso, a cargo de Sandy) y confirmación de dashboards de Auth/Mercado Pago |
