...
| 10. Lanzamiento | 🟡 En curso — no listo para lanzar | 27/8/2026 |  | `main` | `docs/fase10-checklist.md` (checklist inicial 27-28/8, pasada completa de release manager 2/9); bloqueante de migraciones resuelto (40/40, 1 a 1); backup real re-tomado 2/9 (`pg_dump_2026_09_02.sql`, 51/51 tablas con datos); login/auth confirmado de punta a punta contra `tecniurbano.online` real vía magic link admin; quedan prueba de restauración (sin Docker/servidor local), 8/10 flujos del smoke test (frenado por el clasificador de seguridad al entrar al panel de admin, no re-corridos), y confirmación de dashboards de Auth/Mercado Pago |
