...
| 1. Supabase reproducible | 🟡 En curso — esquema reconstruible y RLS verde; faltan seed completo, tipos y clasificación de scripts auxiliares | 23/8/2026 |  | `main` | 1/9: `migration list --linked` 40 local = 40 remoto; CI aprobó `supabase db start`; 11 suites rollback-safe live pasan; falta seed idempotente integral, tipos generados integrados y GRANT/Data API |
