...
| 10. Lanzamiento | 🟡 En curso — no listo para lanzar | 27/8/2026 |  | `main` | `docs/fase10-checklist.md` (checklist inicial 27-28/8); bloqueante de migraciones ("24 aplicadas vs. 6 en repo") **resuelto** — reconfirmado 2/9: 40 aplicadas = 40 archivos locales, 1 a 1; quedan backup real, confirmación de dashboards de Auth/Mercado Pago y smoke test completo re-corrido |
